...
def show_exam_result(request, course_id, submission_id):
    ...
    selected_choice_id = submission.choices.all()
    grade = 0
    context = {}
    for i in selected_choice_id:
        if i.is_it_correct:
            grade +=i.question.grade_point
    context['course'] = course
    context['grade_point'] = grade 
    context['choices'] = selected_choice_id
